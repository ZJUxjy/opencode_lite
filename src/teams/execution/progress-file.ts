 ...
 * 任务状态
 */
export type ProgressTaskStatus = "pending" | "in_progress" | "completed" | "blocked" | "failed"
...
export class ProgressFileManager {
   ...
   * 更新任务状态
   */
  updateTaskStatus(taskId: string, status: ProgressTaskStatus, notes?: string): boolean {
